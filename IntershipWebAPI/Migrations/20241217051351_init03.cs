        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TransporterNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VehicleNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Item = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    umo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Qunatity = table.Column<int>(type: "int", nullable: false),
                    Rate = table.Column<float>(type: "real", nullable: false),
                    LineAmount = table.Column<float>(type: "real", nullable: false),
                    GST = table.Column<float>(type: "real", nullable: false),
                    GSTAmt = table.Column<float>(type: "real", nullable: false),
